...
public class Monobank implements CurrencyTrading {
    ...
    public static void main(String[] args)  throws IOException {
        ...
        System.out.println("Currency: " + currencyRate.getCurrency().name());
        System.out.println("Currency Code: " + currencyRate.getCurrency().getCode());
        System.out.println("EUR: " + currencyRate.getBuy());
        System.out.println("EUR: " + currencyRate.getSell());
    }
}